function [Kj] = ghostPenalty(mesh,mpData)
...
% mpData - material point structured array. 
%--------------------------------------------------------------------------
% Ouput(s);
...
mesh = detBoundElemMulti(mesh,mpData);                                      % determine boundary element information 
...
[~,dN] = shapefunc(nen,GpLoc,nD);                                           % shape function derivatives
if nD==2
