function [Dalg,sig,epsE] = MCconst(epsTr,mCst)
...
[t,epsVal]=eig([epsTr(1)   epsTr(6)/2 epsTr(5)/2; 
                epsTr(6)/2 epsTr(2)   epsTr(4)/2; 
                epsTr(5)/2 epsTr(4)/2 epsTr(3)]);                           % eigen values and vectors of trial strain
